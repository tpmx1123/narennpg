    ...
    <section className="mb-10 sm:mb-14 lg:mb-16 -mt-4 sm:-mt-6 lg:-mt-8 relative z-10">
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          className="pointer-events-none select-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[180px] sm:w-[280px] lg:w-[340px] h-auto object-contain opacity-[0.2]"
        />
