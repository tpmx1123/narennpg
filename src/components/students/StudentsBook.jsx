...
export default function StudentsBook({ onBookVisit }) {
  const bg = STUDENTS_IMAGES.parents;
  ...
  return (
    <section className="relative mb-0 -mx-4 sm:-mx-6 lg:-mx-10 overflow-hidden">
      ...
      >
        ...
        <a
          href={`tel:${PHONE_TEL}`}
          className="inline-block font-display font-bold text-4xl sm:text-5xl lg:text-[3.25rem] text-white tracking-tight leading-none hover:text-brand-gold transition-colors"
        >
          {PHONE_DISPLAY}
        </a>
