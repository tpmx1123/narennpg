  ...
  return (
    <section className="mb-14 lg:mb-16 space-y-12 lg:space-y-14">
      <motion.div
        ...
        className="relative overflow-hidden rounded-[1.75rem] sm:rounded-[2rem] bg-brand-green-pale border border-brand-gold/20 px-7 py-10 sm:px-10 sm:py-12 lg:px-12 lg:py-14 max-w-4xl mx-auto"
      >
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          <div className="lg:col-span-8">
            ...
            <p className="text-sm sm:text-[15px] text-brand-charcoal-light leading-relaxed max-w-2.5xl">
      ...
      >
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 sm:gap-4">
            {onBookVisit ? (
              <IconSlideButton onClick={() => onBookVisit()}>
                {PROPERTIES_VISIT.primaryCta}
              </IconSlideButton>
            ) : (
              <IconSlideButton to="/contact-us/">
                {PROPERTIES_VISIT.primaryCta}
              </IconSlideButton>
            )}
            <a
              ...
              className="inline-flex items-center justify-center rounded-xl border border-brand-charcoal/80 bg-white px-6 py-3.5 text-sm font-display font-bold uppercase tracking-wide text-brand-charcoal hover:border-brand-burgundy hover:text-brand-burgundy transition-colors"
            >
