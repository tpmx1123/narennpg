...
export default function PropertiesStandard() {
  return (
    <section className=" py-10 lg:py-14  px-4 sm:px-6 lg:px-10 bg-brand-cream-dark/60 border-y border-brand-gold/10">
      <motion.div
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-4xl font-display font-bold text-brand-green tracking-tight leading-[1.15] mt-3">
          ...
          {PROPERTIES_STANDARD.cards.map((card, index) => {
            ...
            return (
              <motion.article
                ...
                className="group bg-white rounded-2xl border border-brand-gold/20 p-6 sm:p-7 text-center hover:shadow-[0_16px_40px_-24px_rgba(15,61,46,0.2)] transition-shadow"
              >
