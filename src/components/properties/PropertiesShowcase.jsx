            ...
            >
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 mb-1 sm:mb-4 lg:mb-6">
                ...
                <a
                  ...
                  className="inline-flex lg:hidden items-center gap-1.5 text-xs sm:text-sm font-display font-semibold text-brand-green hover:text-brand-burgundy transition-colors"
                >
