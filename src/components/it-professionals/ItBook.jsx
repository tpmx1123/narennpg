...
export default function ItBook({ onBookVisit }) {
  return (
    <section className="mb-16 lg:mb-20 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 py-12 lg:py-16 border-y border-brand-gold/25 bg-brand-gold-pale/35">
      ...
      >
        <SectionHeading
          eyebrow={IT_BOOK.eyebrow}
          title={IT_BOOK.h2}
          accent={IT_BOOK.h2Accent}
          align="center"
        />
        <p className="text-sm sm:text-base text-brand-charcoal-light leading-relaxed">
          <ContactText>{IT_BOOK.body}</ContactText>
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <a
            ...
            className="inline-flex items-center justify-center w-12 h-12 rounded-xl border border-[#25D366]/40 text-[#25D366] bg-white hover:bg-[#25D366]/10 transition-colors"
          >
