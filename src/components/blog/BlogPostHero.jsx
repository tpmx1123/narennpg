...
export default function BlogPostHero({ post, imageFallback }) {
  ...
  return (
    <section className="relative min-h-[240px] sm:min-h-[320px] lg:min-h-[400px] flex items-end overflow-hidden">
      ...
      <div className="relative z-10 w-full site-container pt-24 sm:pt-28 lg:pt-32 pb-5 sm:pb-8 lg:pb-10">
        <motion.div {...staggerContainerMount}>
          <motion.nav
          ...
          <motion.h1
            {...staggerItemMount}
            className="text-[1.35rem] sm:text-[2rem] lg:text-4xl font-display font-semibold text-[#F7F3E9] max-w-4xl leading-[1.18] sm:leading-[1.15] tracking-tight break-words"
          >
            {post.h1 ?? post.title}
          </motion.h1>

          <motion.div {...staggerItemMount} className="mt-3 sm:mt-4 flex items-center gap-3 min-w-0">
