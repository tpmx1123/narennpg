...
import { SINGLE_SHARING_INCLUDES } from '../../../data/singleSharingData';

const EASE = [0.22, 1, 0.36, 1];

export default function SingleRoomIncludes() {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm sm:text-[15px] text-brand-charcoal-light leading-relaxed mb-6">
        Your private single room is more than four walls — it is a complete living package designed
        for comfort and productivity:
      </p>
      <ul className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
        {SINGLE_SHARING_INCLUDES.map((item, i) => (
          <motion.li
            key={item}
