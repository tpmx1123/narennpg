...
const GRID = [
  ...
  { key: 'studyDesks', className: 'min-h-[160px] sm:min-h-[170px]' },
  { key: 'roommates', className: 'min-h-[160px] sm:min-h-[170px]' },
  { key: 'wardrobes', className: 'sm:col-span-2 min-h-[160px] sm:min-h-[180px]' },
];

export default function DoubleRoomGallery() {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        {GRID.map((item, i) => {
          const image = DOUBLE_SHARING_IMAGES[item.key];
          return (
            <motion.div
              key={item.key}
