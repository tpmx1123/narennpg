...
import { DOUBLE_SHARING_ROOMMATE_MATCHING } from '../../../data/doubleSharingData';
...
export default function DoubleRoomRoommateMatching() {
  const reduceMotion = useReducedMotion();
  const { intro, outro, points } = DOUBLE_SHARING_ROOMMATE_MATCHING;
