...
import { TRIPLE_SHARING_HERO } from '../../../data/tripleSharingData';
...
export default function TripleRoomIntro() {
  return (
    <section className="mb-14 lg:mb-16 -mt-6 sm:-mt-8 relative z-10">
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          loading="lazy" className="pointer-events-none select-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[220px] sm:w-[280px] lg:w-[340px] h-auto object-contain opacity-[0.2]"
        />

        <div className="relative z-10 space-y-5 text-center max-w-5xl mx-auto">
          {TRIPLE_SHARING_HERO.paragraphs.map((para) => (
            <p
              key={para.slice(0, 48)}
