...
import { QUAD_SHARING_SPACE } from '../../../data/quadSharingData';
...
export default function QuadRoomSpace() {
  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 mb-8 lg:mb-10 items-end">
        <div className="lg:col-span-5">
          ...
          <h2 className="section-title">
            ...
            <span className="section-title-accent">Four</span>
          </h2>
        </div>
      </div>
      ...
      >
        {QUAD_SHARING_SPACE.points.map((point, index) => (
          <motion.li
            key={point}
            custom={index}
