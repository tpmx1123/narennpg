...
import { GACHIBOWLI_BOOK, GACHIBOWLI_IMAGES } from '../../../data/gachibowliLocationData';
...
export default function GachibowliBookVisit({ onBookVisit }) {
  const bg = GACHIBOWLI_IMAGES.landmarks;
