    ...
    <section className="mb-8 sm:mb-10 lg:mb-12 -mt-4 sm:-mt-5 lg:-mt-6 relative z-10">
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          loading="lazy" className="pointer-events-none select-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[160px] sm:w-[220px] lg:w-[260px] h-auto object-contain opacity-[0.12]"
        />
