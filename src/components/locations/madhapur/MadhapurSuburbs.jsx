    ...
    <section className="relative mb-8 sm:mb-10 lg:mb-12 py-8 sm:py-10 lg:py-12 -mx-4 sm:-mx-6 lg:-mx-6 px-4 sm:px-6 lg:px-6 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-6 sm:mb-8 space-y-2.5">
          <h2 className="font-display font-bold text-3xl sm:text-[2rem] lg:text-4xl text-white tracking-tight leading-[1.15]">
            {MADHAPUR_SUBURBS.h2}
          </h2>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          {MADHAPUR_SUBURBS.stats.map((stat) => (
            <article
              key={stat.label}
              className="rounded-xl border border-white/10 bg-white/5 p-3 sm:p-5 text-center hover:bg-brand-burgundy/15 transition-colors min-w-0"
            >
              <p className="font-display font-bold text-xl sm:text-3xl text-brand-gold tabular-nums mb-1.5">
                {stat.value}
              </p>
