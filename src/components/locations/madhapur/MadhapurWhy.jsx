  ...
  return (
    <section className="mb-8 sm:mb-10 lg:mb-12">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-12 gap-3 sm:gap-4">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <Coffee className="w-6 h-6 sm:w-7 sm:h-7 text-brand-gold-dark shrink-0" aria-hidden="true" />
            <h3 className="font-display font-semibold text-base sm:text-xl text-brand-charcoal">
              {MADHAPUR_WHY.cards[1].title}
            </h3>
          </div>
          <p className="text-xs sm:text-[15px] text-brand-charcoal-light leading-relaxed sm:pl-10">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            <TrainFront className="w-6 h-6 sm:w-7 sm:h-7 text-brand-burgundy shrink-0" aria-hidden="true" />
            <h3 className="font-display font-semibold text-base sm:text-xl text-brand-charcoal">
