...
export default function HitechCityResidents() {
  return (
    <section className="mb-8 sm:mb-10 lg:mb-12 -mx-4 sm:-mx-6 lg:-mx-6 px-4 sm:px-6 lg:px-6 py-8 sm:py-10 lg:py-12 bg-brand-green-pale/35 border-y border-brand-gold/15">
      <motion.div
