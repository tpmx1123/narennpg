...
export default function HitechCityResidents() {
  return (
    <section className="mb-8 lg:mb-10 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 py-10 lg:py-12 bg-brand-green-pale/35 border-y border-brand-gold/15">
      <motion.div
      ...
      >
        ...
        <ol className="space-y-0 border-t border-brand-charcoal/10">
          {HITECH_CITY_RESIDENTS.bullets.map((item, index) => (
            <li key={item} className="flex gap-4 py-3.5 border-b border-brand-charcoal/10">
