...
import { HITECH_CITY_HERO, HITECH_CITY_IMAGES } from '../../../data/hitechCityLocationData';
import { PHONE_DISPLAY, PHONE_TEL } from '../../../data/sitePages';

const EASE = [0.22, 1, 0.36, 1];

export default function HitechCityHero({ onBookVisit }) {
  const { hero } = HITECH_CITY_IMAGES;
