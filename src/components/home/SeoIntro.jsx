    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-5 lg:gap-2 items-center"
        >
          <div className="lg:col-span-4 xl:col-span-3 flex justify-center lg:justify-start order-1">
            <img
              src={LEGACY_BADGE}
          ...
          <div className="lg:col-span-8 xl:col-span-9 mx-auto lg:mx-0 lg:translate-x-8 xl:translate-x-10 space-y-4 text-center lg:text-left text-brand-charcoal text-sm sm:text-[15px] leading-relaxed font-medium order-2 max-w-xl lg:max-w-3xl">
