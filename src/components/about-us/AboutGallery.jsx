      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col items-center">
        ...
        <div className="relative w-full flex items-center justify-center">
          <button
            ...
            className="absolute left-0 sm:-left-4 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-white/20 bg-brand-charcoal/60 hover:bg-brand-burgundy text-white flex items-center justify-center transition-colors"
          >
          ...
          <button
            ...
            className="absolute right-0 sm:-right-4 z-20 w-10 h-10 sm:w-12 sm:h-12 rounded-full border border-white/20 bg-brand-charcoal/60 hover:bg-brand-burgundy text-white flex items-center justify-center transition-colors"
          >
  ...
  return (
    <section className="mb-14 lg:mb-16 py-2">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 md:grid-rows-2 gap-3 sm:gap-4 auto-rows-[220px] sm:auto-rows-[260px] lg:auto-rows-[300px]">
          <GalleryTile
            image={founderPortrait}
            onOpen={() => openAt(0)}
            className="md:col-span-3 md:row-span-1 aspect-5/6 md:aspect-auto h-full min-h-[240px]"
          />
          <GalleryTile
            image={speaking}
            onOpen={() => openAt(1)}
            className="md:col-span-4 md:row-span-1 aspect-3/2 md:aspect-auto h-full min-h-[200px]"
          />
          <GalleryTile
            image={portrait}
            onOpen={() => openAt(2)}
            className="md:col-span-5 md:row-span-2 aspect-2/3 md:aspect-auto h-full min-h-[280px] md:min-h-0"
          />
          <GalleryTile
            image={fullTeam}
            onOpen={() => openAt(3)}
          ...
          <GalleryTile
            image={opsTeam}
            onOpen={() => openAt(4)}
            className="md:col-span-3 md:row-span-1 aspect-3/2 md:aspect-auto h-full min-h-[200px]"
          />
        </div>
      </motion.div>
