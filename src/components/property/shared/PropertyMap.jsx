...
export default function PropertyMap({ data }) {
  return (
    <section className="pt-12 lg:pt-16 pb-10 lg:pb-12 -mx-4 sm:-mx-6 lg:-mx-10 px-4 sm:px-6 lg:px-10 bg-[#F7F7F5]">
      <motion.div
      ...
      >
        ...
        <div className="lg:col-span-7">
          <div className="w-full h-[260px] sm:h-[320px] lg:h-[360px] rounded-2xl overflow-hidden border border-black/[0.04] bg-white">
            <iframe
