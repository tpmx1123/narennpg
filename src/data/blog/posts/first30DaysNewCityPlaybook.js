...
const first30DaysNewCityPlaybook = {
  blocks: [
    ...
    {
      type: 'h2',
      text: 'Week 1: Get Your Basics in Order',
    },
    {
      type: 'paragraph',
      parts: [
        {
          text: 'Your first week is about stability. Focus on the essentials so daily life runs smoothly:',
        },
      ],
    },
    {
      type: 'list',
      items: [
        'Settle into your accommodation and unpack fully — a made room feels like home',
        'Learn your commute and do a practice run before your first day',
        'Sort local essentials — SIM, banking, and nearby pharmacy, ATM and grocery',
        'Introduce yourself to a few neighbours or co-residents',
      ],
    },
    {
      type: 'h2',
      text: 'Week 2: Build Your Daily Routine',
    },
    {
      type: 'paragraph',
      parts: [
        ...
        { text: ' support a settled daily life.' },
      ],
    },
    {
      type: 'h2',
      text: 'Week 3: Start Making Connections',
    },
    {
      type: 'paragraph',
      parts: [
        ...
        {
          text: ' are designed to help new residents connect quickly, so lean into them.',
        },
      ],
    },
    {
    ...
    {
      type: 'h2',
      text: 'Week 4: Explore and Put Down Roots',
    },
    {
      type: 'paragraph',
      parts: [
    ...
    },
    {
      ...
      parts: [
        {
          text: 'Settling in is a process, not an event. Some days will feel great and others hard, and that is okay. Be patient with yourself, celebrate small wins, and trust that with each week the new city feels more like home. Thirty days in, you will be surprised how far you have come.',
        },
      ],
    },
    {
      type: 'h2',
      text: 'Start Your New Chapter Right',
    },
    {
      type: 'paragraph',
      parts: [
        {
          text: 'A supportive home base makes settling in dramatically easier. Narenn Living gives you comfort, food, security and a ready-made community from day one, so your first 30 days in Hyderabad feel welcoming rather than lonely. Call 70759 85666 or ',
        },
        { type: 'link', href: '/contact-us/', text: 'book a visit' },
        {
          text: ', and begin your new chapter on the strongest possible footing.',
        },
      ],
    },
    {
      type: 'h2',
      text: 'Week One — Logistics',
    },
    {
      type: 'list',
      items: [
    ...
    },
    {
      ...
      parts: [
        {
          text: 'By week four you should have a routine, not just a schedule: a gym slot you keep, a meal you look forward to, two or three people you would text on a Saturday, and a room that feels like yours rather than like a hotel you have overstayed in.',
        },
      ],
    },
    {
  ...
  faqs: [
    {
      question: 'How can I settle into a new city quickly?',
      answer:
        'Get your basics in order in week one, build a daily routine in week two, start making connections in week three, and explore your neighbourhood in week four. A supportive community and handled essentials like food and cleaning make it much easier.',
    },
    {
      question: 'How do I deal with homesickness after moving?',
      answer:
        'Stay in touch with family and friends, but stay engaged with your new life too. Balance comfort from home with active social connection, and lean on the community around you during the adjustment.',
    },
  ],
  sidebarCta: {
...
export default first30DaysNewCityPlaybook;
