...
export const FOOD_PAGE = {
  ...
  description:
    'Experience home-style dining with three fresh meals a day at Narenn Living. Premium co-living with in-house kitchens.',
...
export const FOOD_HERO = {
  ...
  h1Accent: 'Three Fresh Meals a Day',
  paragraphs: [
    'Ask anyone who has lived in a PG what makes or breaks the experience, and the answer is almost always the food. At Narenn Living, we treat PG food in Madhapur as a priority, not an afterthought. Our in-house kitchen serves three freshly cooked meals every day - breakfast, lunch and dinner - prepared in a clean, hygienic kitchen by cooks who take pride in their work. Evening snacks with tea or coffee are also available between lunch and dinner. The result is food that tastes like home, so you never have to depend on takeout or skip a meal because you are too busy.',
...
export const FOOD_SNACKS = {
  title: 'Evening Snacks',
  eyebrow: 'Plus, between meals',
  description:
    'Light evening snacks with tea or coffee to bridge the gap till dinner — served alongside your three meals, not counted as one.',
};
...
export const FOOD_FAQS = [
  {
    ...
    answer:
      'Yes, all three fresh meals a day are part of the standard co-living package at Narenn Living, with evening snacks served separately. There are no hidden daily meal charges.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Breakfast usually runs from 7:30–9:30 AM, lunch from 12:30–2:30 PM, and dinner from 8:00–10:00 PM. Evening snacks are served separately between lunch and dinner. Timings may vary slightly by property.',
  },
];
