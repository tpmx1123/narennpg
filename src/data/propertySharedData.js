...
export const PROPERTY_HIGHLIGHTS = [
  ...
  { icon: 'UtensilsCrossed', title: 'Three meals a day', description: 'Home-style food from our in-house kitchen.' },
  ...
  { icon: 'Sparkles', title: 'Housekeeping', description: 'Daily cleaning of rooms and common areas.' },
