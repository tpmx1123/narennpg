...
export const ROOMS_HERO = {
  eyebrow: 'Rooms Overview',
  lead:
    'Move-in ready AC rooms with meals, WiFi and housekeeping included - minutes from Hitech City in VIP Hills, Madhapur.',
};
...
export const ROOMS_FORMATS = [
  {
    id: 'single',
    eyebrow: '1 Sharing',
    h2: 'Single Sharing Rooms - Your Own Private Space',
  ...
  },
  {
    id: 'double',
    eyebrow: '2 Sharing',
    h2: 'Double Sharing Rooms - Comfort Meets Company',
  ...
  },
  {
    id: 'triple',
    eyebrow: '3 Sharing',
    h2: 'Triple Sharing Rooms - Smart and Economical',
    href: '/rooms/triple-sharing/',
    linkLabel: 'triple sharing rooms',
    imageKey: 'triple',
    paragraphs: [
...
export const ROOMS_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Absolutely. We encourage every prospective resident to book a free visit, tour the rooms, meet the team and taste the food before deciding.',
  },
];
